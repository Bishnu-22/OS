@php
        ...
        $customer_info=DB::table('customer_tbl')
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('/student_dashboard')}}"><img src="" alt="">K-F-C</a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            <div class="profile">
              <img src="{{$customer_info->customer_food}}" alt="">
            </div>
            <div class="details">
              <p class="user-name">{{strtoupper($customer_info->customer_name)}}</p>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{URL::to('/customer_profile')}}">
                <i class="mdi mdi-gauge menu-icon"></i>
                <span class="menu-title">Profile</span>
              </a>
              <a class="nav-link" href="{{URL::to('/customer_setting')}}">
                <i class="mdi mdi-gauge menu-icon"></i>
