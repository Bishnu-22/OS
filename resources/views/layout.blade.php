  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('admin_dashboard')}}"><img src="" alt="">D-I-U</a>
      </div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{URL::to('/allorder')}}">
                <i class="mdi mdi-gauge menu-icon"></i>
                <span class="menu-title">All Order</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{URL::to('/customerorder')}}">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="layoutsSubmenu">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/addnew')}}">Add New</a>
                  </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/')}}">Pizza</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/')}}">Chiken</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/')}}">Nuduls</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/')}}">Chiken Barger</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#advancedSubmenu" aria-expanded="false" aria-controls="advancedSubmenu">
                ...
                <span class="menu-title">Brand/Company</span>
                <i class="mdi mdi-chevron-down menu-arrow"></i>
              </a>
              <div class="collapse" id="advancedSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/addteacher')}}">KFC</a>
                    <a class="nav-link" href="{{URL::to('/allteacher')}}">Dhaka Branch</a>
                  </li>   
